...
상세 항목은 [TODO.md](TODO.md)(한국어) / [TODO.en.md](TODO.en.md), 미구현 기능 카탈로그는
[docs/design/12-feature-gaps.md](docs/design/12-feature-gaps.md)에 있다.
...
| `certify <input> --policy <file> --report <dir>` | 인증 리포트를 원자적으로 게시. [Certification v1](docs/design/16-certification-v1.md) |
| `corpus --manifest <file> --report <dir>` | 고정 구조 코퍼스 게이트. [코퍼스 계약](docs/design/17-structured-corpus-v1.md) |
...
정본 스키마는 [`schemas/`](schemas/)에, 계약 문서는 [13-document-spec-v1](docs/design/13-document-spec-v1.md),
[14-template-spec-v1](docs/design/14-template-spec-v1.md), [15-document-spec-v2](docs/design/15-document-spec-v2.md)에 있다.
...
계약 상세는 [17-structured-corpus-v1](docs/design/17-structured-corpus-v1.md), 인증 계약은
[16-certification-v1](docs/design/16-certification-v1.md).
...
- 사용자용 문서는 한국어 정본과 영문 페어(`NAME.md` / `NAME.en.md`)를 같은 커밋에서 함께 갱신한다.
...
파생물)를 동봉하지 않고 공식 배포처 링크만 제공한다([docs/README.md](docs/README.md) 참고).
