...
| **Medium value** | GC-6 (multi-column text boxes), ~~GE-2~~ (picture drop, resolved 2026-08-19) and GE-3 to GE-6 (columns, number synthesis), GF-1 (%unk), **GB-12** (bibliography), **GE-β1, β2, β5** (preview, scripts, settings), ~~GG-16~~ (local rendering, resolved in PR 9 alongside GG-5, GG-6, GG-8 to GG-11, GG-17, GG-20, GG-21, GG-22 from 2026-08-13/14), ~~GH-3, GH-4, GH-5~~ (footnote markers, merged cells, in-cell blocks; markdown resolved 2026-07-18, html and odt 2026-08-01), ~~GJ-5 and GJ-6~~ (csv, txt, resolved 08-01). ✅ the whole GI series and GE-7 resolved on 07-19. ~~GK-3, GK-4, GK-6, GK-8~~, ~~GM-1, GM-2, GM-5~~, ~~GM-3, GM-4, GM-8~~ (merge, split, compare — shipped in v0.13.0 and spot-checked in Hancom on 2026-08-29; see the rows above), **GM-6** (corrected to already-covered), GM-7 (sealing, resolved 07-16) — ✅ resolved in the 2026-08-01 batch | GB-4 to GB-7 and GB-10 (word art, forms, grouping, memos, master pages), GC-1 (vertical writing), GD-1 to GD-3 (equations; rhwp precedent), ~~GE-α6~~ (gradient center and step, resolved 2026-08-19), GF-3 (field creation), **GB-1 hwpx chart generation ★** (chartSpace; kordoc precedent), **GJ-2 and GJ-3** (hml, HWP 3.x; specifications public), **GG-7, GG-12 to GG-15, GG-18, GG-19** (render pixel comparison), **GE-β3 and β6** (DocOptions, embedded fonts), **GH-7** (ODT layout), **GK-5 and GK-7** (header editing, styles), **GM-10** (PII redaction; kordoc precedent) | GB-2 and GB-3 (OLE, video), **GJ-1 full round-trip** (DOCX import; 2026-08-20 disposition: stays out of scope and is revisited only after every other roadmap item is complete — the same call covers PDF, XLS and XLSX import, with kordoc as the covering tool meanwhile), **GM-9 Web** (authenticated hosted MCP, tenant isolation and operations; Desktop is resolved) |
...
[official specification exists, no reverse engineering needed] ──▶ GA-2 ✅ (distribution decryption, 배포용문서 rev1.2)
   ...
   │
[independent, immediately actionable] ──▶ GE-α6 ✅ (gradient center and step, resolved 2026-08-19; α1 to α5, α7 and α8 ✅ resolved 2026-07-15)
                    GE-2 ✅    (local to write.rs; the picture drop became BinRef resolution, resolved 2026-08-19)
                    GA-3/GA-4  (refusal messages; the GA-5 version gate is ✅ resolved)
                    GC-4 render ✅ (tab positions and leaders applied in hwp-render/tab.rs, resolved 2026-08-19; the round-trip is ✅ resolved)
...
(export only; input remains L-tier) — the next large item was the GM-3/4/8 family, spot-checked in Hancom on 2026-08-29; the milestone now moves to the release gate. Milestone 1 then closed with the Phase 1 fidelity trio (GE-α6, GE-2 and GC-4 render, PR #115 on 2026-08-19), leaving the release gate itself as the remaining work before v1.0: readiness records, claim discipline, and the catalog sweep this section reflects.
