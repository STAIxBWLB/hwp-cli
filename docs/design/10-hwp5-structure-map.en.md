...
|---|---|---|
| [02-hwp5-read](02-hwp5-read.en.md) | **How to parse**: bit layouts, cursors, tree reconstruction algorithms | Linked from here as "details in [02] §n". This document is the *map*; 02 is the *implementation specification* |
| [03-hwp5-write](03-hwp5-write.en.md) | **Synthesis and writing**: CFB V3, version gating, Hancom-compatible assembly | The write column of the stream tree (§1) summarizes 03 |
| [12-feature-gaps](12-feature-gaps.en.md) | **Unimplemented and loss list**: what Opaque and raw-preserved records actually lose | The `Opaque` and `raw-preserved` rows of tables A and B here are 12's input |
...
| `/DocOptions/{Drm*,CertDrm*,DigitalSignature,PublicKeyInfo}` | 3.2.8 | unparsed | **not emitted** | no | (no branch; [12](12-feature-gaps.en.md) GE-β3) |
...
| `/Bibliography/*` | 3.2.12 | unsupported (passed over) | none | - | (no branch; [12](12-feature-gaps.en.md) GB-12) |
