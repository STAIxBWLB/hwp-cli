...
| [12-feature-gaps](12-feature-gaps.md) | **미구현·손실 목록** — Opaque/raw보존 레코드가 실제로 무엇을 잃는가 | 이 문서 표 A/B의 `Opaque`·`raw보존` 행이 12의 입력 |
| [13-hwp5-spec-supplement](13-hwp5-spec-supplement.md) | **명세 보완 색인** — 정오표·버전 매트릭스·적합성 규칙·소비 의미론 | 이 문서의 ★ 항목이 13 §1 정오표의 입력 |
