...
`OpaqueRecord`. Details in [01-architecture-ir.md](01-architecture-ir.en.md).
...
| # | Document | Contents |
|---|---|---|
| 01 | [architecture-ir](01-architecture-ir.en.md) | Crate structure, IR type hierarchy, data flow, OpaqueRecord |
| 02 | [hwp5-read](02-hwp5-read.en.md) | CFB, record header bit layout, DocInfo and BodyText parsing, compression and encoding |
| 03 | [hwp5-write](03-hwp5-write.en.md) | **Hancom-compatible synthesis** (CFB V3, EncryptVersion, COMPATIBLE_DOCUMENT, version gating) |
| 04 | [hwpx-owpml](04-hwpx-owpml.en.md) | HWPX ZIP (OPC), hp:/hc: elements, shape geometry, floating and inline placement |
| 05 | [rendering](05-rendering.en.md) | Layout, lineseg synthesis, shape drawing, font shaping, PNG/SVG/PDF |
| 06 | [convert-cli-methodology](06-convert-cli-methodology.en.md) | Conversion pipeline, CLI, **the ground-truth methodology and diagnostics** |
| 07 | [hangul-compat-rules](07-hangul-compat-rules.en.md) | ★ **The full catalog of Hancom compatibility rules confirmed by testing** |
| 08 | [external-research](08-external-research.en.md) | External evidence on the OWPML standard, open source and pagination behavior |
| 09 | [diagnostic-corpus](09-diagnostic-corpus.en.md) | The feature-isolating diagnostic corpus and self-verification harness |
...
5. **The Hancom gate.** Whether a file actually opens and renders correctly in Hancom Office is the
   final verdict. See [06](06-convert-cli-methodology.en.md) and [07](07-hangul-compat-rules.en.md).
...
[08](08-external-research.en.md). Beyond that: U2 (justified alignment), U4 (letter spacing) and
text-box render precision. The full catalog of unimplemented features and loss points, with the
roadmap, is in [12-feature-gaps.en.md](12-feature-gaps.en.md).

**★ The most valuable asset:** [07-hangul-compat-rules](07-hangul-compat-rules.en.md), roughly thirty
