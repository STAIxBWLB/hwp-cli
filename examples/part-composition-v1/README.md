...
[docs/design/18](../../docs/design/18-html-fragment-contract.md))로 작성한다.
...
- 부분 안 이미지의 상대 경로는 부분 파일 위치가 기준이다. SVG는 v1에서
  DocumentSpec v2의 svg visual 경로(`hwp compose`)를 사용한다.
