...
- [ ] Data policy respected (no fixtures committed beyond the fixtures/samples exception, no Hancom specification or derivatives bundled — AGENTS.md "Data policy")
- [ ] Design documents updated where applicable: `docs/design/12-feature-gaps.md` statuses, the structure maps (10 and 11), README and AGENTS.md
...
- Branch and PR policy: AGENTS.md "Branch · PR policy". No direct pushes to main; squash merge once CI is green.
